...
{
    public class DegreeSubjectOtherBusinessResultBuilder : ResultBuilder
    {
        public DegreeSubjectOtherBusinessResultBuilder(Application application) : base(application)
        {
