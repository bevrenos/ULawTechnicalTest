...
namespace ULaw.ApplicationProcessor.Tests
{
    ...
    public class ApplicationSubmissionTests
    {
        ...
        private IApplicationService ApplicationService => new ApplicationService(_mockDegreeServiceBuilder.Object);

        private Mock<IDegreeServiceBuilder> _mockDegreeServiceBuilder;

        public ApplicationSubmissionTests()
        {
            _mockDegreeServiceBuilder = new Mock<IDegreeServiceBuilder>();
        }

        private void MockValue(string value)
        {
            _mockDegreeServiceBuilder.Setup(x => x.DegreeGradeThirdService(It.IsAny<Application>())).Returns(value);
            _mockDegreeServiceBuilder.Setup(x => x.DegreeGradeTwoTwoService(It.IsAny<Application>())).Returns(value);
            _mockDegreeServiceBuilder.Setup(x => x.DegreeSubjectLawBusinessService(It.IsAny<Application>())).Returns(value);
            _mockDegreeServiceBuilder.Setup(x => x.DegreeSubjectOtherBusinessService(It.IsAny<Application>())).Returns(value);
        }
        ...
        public void ApplicationSubmissionWithFirstLawDegree()
        {
            ...
            MockValue(OfferEmailForFirstLawDegreeResult);
            var emailHtml = ApplicationService.Process(thisSubmission);
        ...
        public void ApplicationSubmissionWithFirstLawAndBusinessDegree()
        {
            ...
            MockValue(OfferEmailForFirstLawAndBusinessDegreeResult);
            var emailHtml = ApplicationService.Process(thisSubmission);
        ...
        public void ApplicationSubmissionWithFirstEnglishDegree()
        {
            ...
            MockValue(FurtherInfoEmailResult);
        ...
        public void ApplicationSubmissionWithTwoOneLawDegree()
        {
            ...
            thisSubmission.DegreeSubject = DegreeSubjectEnum.law;
            MockValue(OfferEmailForTwoOneLawDegreeResult);
        ...
        public void ApplicationSubmissionWithTwoOneLawAndBusinessDegree()
        {
            ...
            thisSubmission.DegreeGrade = DegreeGradeEnum.twoOne;
            thisSubmission.DegreeSubject = DegreeSubjectEnum.lawAndBusiness;
            MockValue(OfferEmailForTwoOneLawAndBusinessDegreeResult);
        ...
        public void ApplicationSubmissionWithThirdDegree()
        {
            ...
            thisSubmission.DegreeSubject = DegreeSubjectEnum.maths;
            MockValue(RejectionEmailForAnyThirdDegreeResult);
